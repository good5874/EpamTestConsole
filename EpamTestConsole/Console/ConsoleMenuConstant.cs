...
{
    public static class ConsoleMenuConstant
    {
        public const string CreateTest = "1. Создать тест";
        public const string StartTest = "2. Пройти тест";
        ...
        public const string EditQuestion = "2. Редактировать вопрос";
        public const string AddQuestions = "3. Добавить вопросы";
        ...
        public const string EditNameQuestion = "1. Изменить текст вопроса";
        public const string EditAnswerQuestion = "2. Изменить ответ на вопрос";
        public const string AddAnswerOption = "3. Добавить варианты ответов на вопросы";
        ...
        public const string EnterAnswer = "Введите ответ: ";
